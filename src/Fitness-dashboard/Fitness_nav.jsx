            ...
            <nav className='navbar navbar-expand-lg bg-dark shadow-sm py-2 px-5'>
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav ms-auto gap-4">
                        ...
                        <li className="nav-item">
                            <NavLink to='/workout' className={({ isActive }) => isActive ? 'nav-link text-light active-link' : 'nav-link'}>Workout</NavLink>
                        </li>

                        <li className="nav-item">
                            <NavLink to='/bmi' className={({ isActive }) => isActive ? 'nav-link text-light active-link' : 'nav-link'}>Bmi</NavLink>
                        </li>

                        <li className="nav-item">
                            <NavLink to='/about' className={({ isActive }) => isActive ? 'nav-link text-light active-link' : 'nav-link'}>About</NavLink>
                        </li>
                    </ul>
